...
public class OperationDao extends AbstractDao<Operation, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Operation entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Operation entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Operation entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Operation entity) {
